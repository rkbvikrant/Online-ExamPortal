...
<table width="100%" border="0">
  ...
  <tr>
    <td height="296" valign="top"><div align="center">
        <h1 class="style8">Welcome to Student Online Examination Portal(SOEP)</h1>
...
<p align="left" class="style5">&nbsp;</p>
      <blockquote>
          <p align="left" class="style5"><span class="style7">HK!`WelCome to SOEP.Portal which is Designed To provide a series of nice questionaire for the students.This Site will provide the quiz for various subject of interest. 
